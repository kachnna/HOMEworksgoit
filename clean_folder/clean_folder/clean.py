...
def sorting_folder(folder_path):
    for root, list, files_list in os.walk(folder_path):
        for filename in files_list:  # filename - nazwa pliku
